 ...
 * <p>An FFmpeg session.
 */
public class FFmpegSession extends com.arthenica.ffmpegkit.AbstractSession implements com.arthenica.ffmpegkit.Session {

    /**
     * Session specific statistics callback.
     */
    private final com.arthenica.ffmpegkit.StatisticsCallback statisticsCallback;
     ...
     */
    private final List<com.arthenica.ffmpegkit.Statistics> statistics;
    ...
    public static FFmpegSession create(final String[] arguments) {
        return new FFmpegSession(arguments, null, null, null, com.arthenica.ffmpegkit.FFmpegKitConfig.getLogRedirectionStrategy());
    }
     ...
     * @return created session
     */
    public static FFmpegSession create(final String[] arguments, final com.arthenica.ffmpegkit.FFmpegSessionCompleteCallback completeCallback) {
        return new FFmpegSession(arguments, completeCallback, null, null, com.arthenica.ffmpegkit.FFmpegKitConfig.getLogRedirectionStrategy());
    }
    ...
    public static FFmpegSession create(final String[] arguments,
        ...
        return new FFmpegSession(arguments, completeCallback, logCallback, statisticsCallback, com.arthenica.ffmpegkit.FFmpegKitConfig.getLogRedirectionStrategy());
    }
     ...
     */
    public com.arthenica.ffmpegkit.StatisticsCallback getStatisticsCallback() {
     ...
     */
    public com.arthenica.ffmpegkit.FFmpegSessionCompleteCallback getCompleteCallback() {
     ...
     */
    public List<com.arthenica.ffmpegkit.Statistics> getAllStatistics(final int waitTimeout) {
        waitForAsynchronousMessagesInTransmit(waitTimeout);

        if (thereAreAsynchronousMessagesInTransmit()) {
            android.util.Log.i(com.arthenica.ffmpegkit.FFmpegKitConfig.TAG, String.format("getAllStatistics was called to return all statistics but there are still statistics being transmitted for session id %d.", sessionId));
        }
     ...
     * @return list of statistics entries generated for this session
     */
    public List<com.arthenica.ffmpegkit.Statistics> getAllStatistics() {
     ...
     */
    public List<com.arthenica.ffmpegkit.Statistics> getStatistics() {
     ...
     * received
     */
    public com.arthenica.ffmpegkit.Statistics getLastReceivedStatistics() {
        synchronized (statisticsLock) {
     ...
     */
    public void addStatistics(final com.arthenica.ffmpegkit.Statistics statistics) {
        synchronized (statisticsLock) {
